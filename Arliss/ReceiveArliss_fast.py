...
receivePhotoArrayLogPath = r"receivePhotoLog1"
receivePhotoArrayLog = ""
array = [[[0]*3]*80]*60
array = np.zeros_like(array)
I = list(range(5))
receivePhotoFlug = 0
receivePhotoPath = r"1receivePhoto"
restorePhotoPath = r"1restorePhoto"
receivearrayPath = r"1receivearray"
receivePhotoName = ""
restorePhotoName = ""
receivePhotoData = ['', '', '', '', '']
